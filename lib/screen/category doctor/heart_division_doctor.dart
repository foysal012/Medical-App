...
class HeartDivisionDoctor extends StatefulWidget {
  const HeartDivisionDoctor({Key? key}) : super(key: key);

  @override
  State<HeartDivisionDoctor> createState() => _HeartDivisionDoctorState();
}

class _HeartDivisionDoctorState extends State<HeartDivisionDoctor> {
