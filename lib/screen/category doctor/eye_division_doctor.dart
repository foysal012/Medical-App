...
class EyeDivisionDoctor extends StatefulWidget {
  const EyeDivisionDoctor({Key? key}) : super(key: key);

  @override
  State<EyeDivisionDoctor> createState() => _EyeDivisionDoctorState();
}

class _EyeDivisionDoctorState extends State<EyeDivisionDoctor> {
