...
class DiagonasticTestPageScreen extends StatefulWidget {
  const DiagonasticTestPageScreen({Key? key}) : super(key: key);

  @override
  State<DiagonasticTestPageScreen> createState() => _DiagonasticTestPageScreenState();
}

class _DiagonasticTestPageScreenState extends State<DiagonasticTestPageScreen> {
  @override
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Get started with your first health checkup",
              style: TextStyle(
                  fontWeight: FontWeight.bold,
