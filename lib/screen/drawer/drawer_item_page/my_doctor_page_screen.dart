...
class MyDoctorPageScreen extends StatefulWidget {
  const MyDoctorPageScreen({Key? key}) : super(key: key);

  @override
  State<MyDoctorPageScreen> createState() => _MyDoctorPageScreenState();
}

class _MyDoctorPageScreenState extends State<MyDoctorPageScreen> {
                            ...
                            child: ListView.separated(
                              itemBuilder: (context, index){
                                Container(
                                  ...
                                  child: Text("list of ${favouritelist.toString()}"),
                                );
                              },
                      ...
                      return Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              children: [
                                Image.network("${listofDentistDoctor[index].imgurl}",height: 120, width: 100,),
                                Column(
                                  children: [
                                    Row(
                                      //mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Text("${listofDentistDoctor[index].name}",
                                          style: TextStyle(
                                        ...
                                        InkWell(
                                          onTap: (){
                                            var val = listofDentistDoctor[index].icon;
                                            setState(() {
                                              //isvalue = !isvalue;
                                              if(val == isvalue){
                                                listofDentistDoctor[index].icon = false;
                                              } else{
                                                listofDentistDoctor[index].icon = true;
                                                if(listofDentistDoctor[index].icon = true){
                                                  //favouritelist.add(listofDentistDoctor[index]);
                                                  favouritelist.add(listofDentistDoctor[index]);
                                                  print(favouritelist.toString());
                                                }else if(listofDentistDoctor[index].icon = false){
                                                  favouritelist.remove(listofDentistDoctor[index]);
                                                  setState(() {
                                          ...
                                          child: Icon(listofDentistDoctor[index].icon == true ? Icons.favorite_outlined : Icons.favorite_outline,
                                            color: listofDentistDoctor[index].icon == true ? Colors.red : Colors.black,),
                                    ...
                                    Text("${listofDentistDoctor[index].position}",
                                      style: TextStyle(
                                          color: Colors.green,
                                    ...
                                    Text("${listofDentistDoctor[index].experience}",
                                      // style: TextStyle(
                                      //     color: Colors.green,
                                      //     fontWeight: FontWeight.w600,
                                      //     fontSize: 14
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text("${listofDentistDoctor[index].performence}",
                                              // style: TextStyle(
                                              //     color: Colors.green,
                                              //     fontWeight: FontWeight.w600,
                                              //     fontSize: 14
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text("${listofDentistDoctor[index].patientnumber}",
                                              // style: TextStyle(
                                              //     color: Colors.green,
                                              //     fontWeight: FontWeight.w600,
                                              //     fontSize: 14
                              ...
                              children: [
                                Column(
                                  children: [
                                    ...
                                    Text("${listofDentistDoctor[index].isavailable}",
                                      // style: TextStyle(
                                      //   color: Colors.green,
                                      //   fontWeight: FontWeight.w900,
                                      // ),
                                ...
                                InkWell(
                                  onTap: (){
                                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>BookingDoctorPage1(
                                      dentistDoctorModelClass: listofDentistDoctor[index],
                                    )));
                                  },
                                  child: Container(
                                    height: 50,
